    ...
    *,
    ...
    if crystalstructure is None:
        ...
        if crystalstructure not in structures:
            raise ValueError(
                "No suitable reference data for bulk {}."
    ...
    if a is None:
        ...
        try:
            ...
            raise KeyError('No reference lattice parameter "a" for "{}"'.format(name))
    ...
    if orthorhombic and crystalstructure not in ["sc", "tetragonal", "orthorhombic"]:
    ...
    if crystalstructure == "sc":
        ...
        atoms = Atoms(
            ...
            cell=[(a, 0, 0), (-a / 2, a * sqrt(3) / 2, 0), (0, 0, covera * a)],
            pbc=True,
        )
        ...
        atoms = Atoms(
            ...
            cell=[(a, 0, 0), (-a / 2, a * sqrt(3) / 2, 0), (0, 0, a * covera)],
            pbc=True,
        )
