...
def dcdftb(
    ...
    with open("cmmd.in", "w") as f:
        if method == "DFTB2_gammah":
            ...
            print(
                "SCC=(LC={} DAMPXH=TRUE DAMPXHZETA=4.5 ECONV={} DCONV={})".format(
                    lc, econv, dconv
                ),
                file=f,
            )
            ...
            if dispersion != "D3H5":
                print(
                    "SCC=(THIRDFULL=TRUE DAMPXH=TRUE DAMPXHZETA=4.0 LC={} ECONV={} DCONV={})".format(
                        lc, econv, dconv
                    ),
                    file=f,
                )
                ...
                print(
                    "SCC=(THIRDFULL=TRUE DAMPXH=FALSE LC={} ECONV={} DCONV={})".format(
                        lc, econv, dconv
                    ),
                    file=f,
                )
            ...
            print("DC=FALSE", file=f)
            print(
                "SCC=(THIRDDIAG=TRUE DAMPXH=TRUE DAMPXHZETA=4.95 LC={} ECONV={} DCONV={})".format(
                    lc, econv, dconv
                ),
                file=f,
            )
        ...
        gbsolventtype = {
            ...
            "benzaldehyde": "21",
            "octanol": "23",
            "dimethylacetamide": "26",
            "ethanol": "25",
            "formamide": "27",
            "methylethylketone": "28",
        }
        if solvent != "none":
            if job == "td":
                if solvent == "ethanol":
                    gbsolventtype[solvent] = 4
                print(
                    "SCC=(ALPB=TRUE GBSOLVENTTYPE={} GBPARAMTYPE=7)".format(
                        gbsolventtype[solvent]
                    ),
                    file=f,
                )
                ...
                print(
                    "SCC=(ALPB=TRUE GBSOLVENTTYPE={} GBPARAMTYPE=4)".format(
                        gbsolventtype[solvent]
                    ),
                    file=f,
                )
        ...
        if job == "td":
            print(
                "TD = (NSTATE={} TARGETSTATE={} MULT={} OSCSTR={} WRITETRANSITION = {})".format(
                    nroots, target, transmult, ocsstr, writetrans
                ),
                file=f,
            )
        if dispersion == "D3":
        ...
        if "cell" in job:
            opt_type = {"bfgs": "1", "sd": "2", "cg": "3", "qm": "4", "fire": "5"}
            print(
                "OPT=(MAXITER=1000 OPTTYPE={} LATTICEOPT=TRUE)".format(
                    opt_type[opttype]
                ),
                file=f,
            )
        if "freq" in job:
            print(
                "FREQ=(THERMOTEMP={} THERMOPRES={} FREQTYPE={})".format(
                    temp, pressure, freqtype
                ),
                file=f,
            )
        if ensembel == "NVE":
        ...
        if job == "md":
            if ensembel == "NVT":
                ...
                nvt = "FALSE"
            print(
                "MD=(NVT={} NVTTYPE={} BATHTEMP={} ERRORTEMP=100)".format(
                    nvt, thermo, temp
                ),
                file=f,
            )
            print(
                "MD=(DELTAT={} NSTEP={} PRINT={})".format(
                    deltat * 1e-15, step, mdprint
                ),
                file=f,
            )
            if softpot == "true":
                print(
                    "MD=(SOFT=TRUE SOFTSHAPETYPE={} SOFTRANGE={} SOFTCENTERTYPE={})".format(
                        softtype, softrange, softcenter
                    ),
                    file=f,
                )
            if restart == "true":
        ...
        if job == "mtd":
            ...
            print(
                "MD=(METADYNAMICS=TRUE METARESTART={} METAPRINTFES=TRUE METAFREQ={} METAHEIGHT={})".format(
                    metarest, metafreq, metaheight
                ),
                file=f,
            )
            if softpot == "true":
            ...
            with open("metacv.dat", "w") as fcv:
                ...
                if cvtype == "coordnum":
                    print(
                        """RATIONALCOORDINATIONNUMBER {} {} {} {} {} {} LABELS AVERAGE {} {} {} 
{}
{}
                """.format(
                            metawidth,
                ...
                if cvtype == "distance":
                    print(
                        "BONDDISTANCE {} {} {} {} {} {}".format(
                            metawidth, ag1, ag2, fesstart, fesend, fesbin
                        ),
                        file=fcv,
                    )
                if cvtype == "angle":
                    print(
                        "BONDANGLE {} {} {} {} {} {} {}".format(
                            metawidth, ag1, ag2, ag3, fesstart, fesend, fesbin
                        ),
                        file=fcv,
                    )
                if cvtype == "dihedral":
                    print(
                        "BONDDIHEDRAL {} {} {} {} {} {} {} {}".format(
                            metawidth, ag1, ag2, ag3, ag4, fesstart, fesend, fesbin
                        ),
                        file=fcv,
                    )
                if cvtype == "distancediff":
                    print(
                        "BONDDISTANCEDIFFERENCE {} {} {} {} {} {} {} {}".format(
                            metawidth, ag1, ag2, ag3, ag4, fesstart, fesend, fesbin
                        ),
                        file=fcv,
                    )
...
{}
                ...
                if cvtype == "pointplanedistance":
                    print(
                        "ATOMPOINTPLANCEDISTANCE {} {} {} {} {}".format(
                            metawidth, ag1, ag2, ag3, ag4
                        ),
                        file=fcv,
                    )
        ...
        for element in elements:
            if (
                method == "DFTB2"
                or method == "DCDFTB2"
                or method == "DFTB3-diag"
                or method == "DCDFTB3-diag"
                or method == "DFTB2_gammah"
                or method == "DCDFTB2_gammah"
            ):
